...
public class BinarySearchTreeLookup {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("min is"+min(head/*,null*/));
    ...
    /*
    public static Integer min(Node<Integer> head,Integer min) {
        ...
        return min(head.getLeftChild(), min);
    }
    */
    public static Integer min(Node<Integer> head) {
