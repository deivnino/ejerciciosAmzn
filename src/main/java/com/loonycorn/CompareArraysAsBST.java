...
//if first indexes are bigger than end ones return true
    ...
    public static void main(final String[] args) {
        ...
        */
        ...
        areBSTEqual(new int[] {2, 1, 3}, new int[] {2, 3, 1});
        areBSTEqual(new int[] {5, 1, 3, 4, 8, 7, 6}, new int[] {5, 8, 1, 3, 7, 6, 4});
        areBSTEqual(new int[] {3, 2, 3}, new int[] {2, 3, 1});
        areBSTEqual(new int[] {2, 1, 3, 5}, new int[] {2, 3, 1});
        areBSTEqual(new int[] {4, 2, 3, 1, 7}, new int[] {4, 2, 1, 3, 7});
        areBSTEqual(new int[] {}, new int[] {});
        areBSTEqual(null, null);
    }
}